  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-[#FAF7F0] text-zinc-900 font-sans">
        ...
        <a 
          href="#main-content" 
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-[#F87C22] text-white border-2 border-black px-4 py-2 font-black z-50 shadow-[2px_2px_0px_rgba(0,0,0,1)] select-none"
        >
          Skip to content
        </a>
        ...
        <LanguageProvider>
          <ParticipateModalProvider>
            ...
            <div className="relative lg:z-20 bg-[#FAF7F0] bg-tribal-watermark min-h-screen lg:shadow-[0_15px_30px_rgba(0,0,0,15)] pb-1 overflow-x-clip">
