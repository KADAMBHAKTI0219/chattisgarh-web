...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-screen min-h-screen  -mx-4 md:-mx-8 lg:-mx-12 overflow-hidden flex flex-col items-center justify-center -pt-[100px]  lg:pb-12 p-6 select-none z-10 bg-white">
